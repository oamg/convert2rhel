...
import convert2rhel.bootloader.grub
...
def _add_rhel_boot_entry(efibootinfo_orig):
    ...
    """
    dev_number = get_device_number(convert2rhel.bootloader.grub.get_efi_partition())
...
def post_ponr_set_efi_configuration():
    ...
    if not convert2rhel.bootloader.grub._copy_grub_files(["grubenv", "grub.cfg"], ["user.cfg"]):
