...
class ConfigureHostMetering(actions.Action):
    ...
    def run(self):
        ...
        :return: True if host-metering is configured successfully, False otherwise (used mainly for testing).
        :rtype: bool
        """
        ...
        if ret_install:
            ...
            self.add_message(
                ...
                description="Failed to install host-metering rpm.",
        ...
        if any(command):
            self.add_message(
                ...
                title="Failed to configure host metering.",
                description="Failed to enable and start host metering service.",
