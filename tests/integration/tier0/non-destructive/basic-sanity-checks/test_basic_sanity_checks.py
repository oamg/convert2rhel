...
def test_c2r_version_latest_raise_older_version_error(convert2rhel, c2r_version, version):
    """
...
@pytest.mark.parametrize("version", ["0.01.0"])
def test_c2r_version_latest_override_older_version_error(convert2rhel, c2r_version, version):
    """
